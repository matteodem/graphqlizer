...
export const createCollectionSchema = config => {
  ...
  const typeFields = mergeTypeFields(mapSchemaToTypeFields(typeSchema), fields.type)
  const inputFields = mergeTypeFields(mapSchemaToTypeFields(inputSchema), fields.input)
